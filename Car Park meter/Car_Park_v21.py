...
def SummaryReport(DataBase):
    ...
    TotalCars =0
    Income = 0
    Lowest = 1000                                           #Lowest has to be lower than 1000
    Highest = 1
    ...
    for Record in DataBase:                                 #For loop for the DataBase Record
        ...
        Average = Income/TotalCars
        Ticket = int(Record[1])
        Income = Income + Ticket
    ...
    print("The total amount of income is: £%.2f" %Income)
    print("The average ticket price is : £%.2f" %Average)   #The "%" acts as a place holder and the "%Average" replaces the "%" and the .2f rounds to 2 decimal places no matter if the number was an integer and not a float 
    print("The lowest price paid was: £%.2f" %Lowest )
    print("The highest price paid was: £%.2f" %Highest)
