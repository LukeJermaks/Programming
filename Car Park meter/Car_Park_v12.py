...
def LoadData():
    ...
    while Line != "":                                   #Prints 
        ...
        #~~Variable Labels~~#
        RegLabel = "Registration: ", Reg                
        TPLabel = "Ticket Price: £", TicketPrice
        ChangeLable = "Chage given: £", Change
                                                        #A line of Record.append() is needed for each variable that you want to show up
        Record.append(RegLabel)                              
        Record.append(TPLabel)                      
        Record.append(ChangeLable)                           
        
        print(Record)                                   #Prints the variable "Record" (A list of selected variables) 
